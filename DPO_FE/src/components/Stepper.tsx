        ...
        <div className="lg:flex justify-center  items-center w-full space-y-4 lg:space-y-0 lg:space-x-4">
          ...
          <div className="relative ">
            <a href="https://pagedone.io/" className="flex items-center font-medium w-full  ">
              <span
                className="w-6 h-6 bg-orange-500 border border-transparent rounded-full flex justify-center items-center mr-3 text-sm text-white lg:w-8 lg:h-8"> 1 </span>
              <div className="block">
                <h4 className="text-base  text-orange-500">Nộp thủ tục trực tuyến</h4>
              </div>
              <svg className="w-5 h-5 ml-2 stroke-orange-500 sm:ml-4 " viewBox="0 0 24 24" fill="none"
